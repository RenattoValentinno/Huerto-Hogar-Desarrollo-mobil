...
fun ProductoFormScreen(
    ...
    val productos: List<Producto> by viewModel.producto.collectAsState()
    ...
    {// inicio inner
        ...
        { // Inicio Contenido
            ...
            Text("Pedidos realizados : ",style =MaterialTheme.typography.headlineSmall) //style libreria material theme
